        ...
        for x in self.videos:
            if x.title == movie:
                if x.adult_mode and self.current_user.age < 18:
                    print('Вам не исполнилось 18 лет, пожалуйста, покиньте страницу!')
                    return
...
if __name__ == '__main__':
    ...
    ur.register('vassal_pupkin', 'lolkekcheburek', 13)
    ur.watch_video('Для чего девушкам парень программист?')
    ur.register('urban_pythonist', 'iScX4vIJClb9YJavaAgF', 25)
    ur.watch_video('Для чего девушкам парень программист?')

    # Проверка входа в другой аккаунт
    ur.register('vassal_pupkin', 'F8098FM8fjm9jmi', 55)
